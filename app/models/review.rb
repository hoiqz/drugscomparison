class Review < ActiveRecord::Base
  attr_accessible :comments, :drug_id, :ease_of_use, :effectiveness, :review_url, :satisfactory, :similar_experience, :tag_cloud_path, :tolerability, :usage_duration_days, :user_id, :user_attributes
  belongs_to :drug
