class ConditionsController < ApplicationController
  ...
  def show
    ...
    if (params[:button]=="sat-table" || params[:button]=="eff-table" || params[:button]=="eou-table" )
      @metric=Hash.new
    ...
    # for pie charts
    if (params[:button]=="satisfactory_view" || params[:button]=="effectiveness_view" || params[:button]=="eou_view" ||
        params[:button]=="effectlink" || params[:button]=="eoulink" || params[:button]=="satisfylink")
      ...
      @drugs.each do  |drug|
        ...
        if(params[:button]=="satisfactory_view" || params[:button]=="satisfylink")
        ...
        elsif(params[:button]=="effectiveness_view" || params[:button]=="effectlink")
