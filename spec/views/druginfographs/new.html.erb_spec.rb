...
describe "druginfographs/new.html.erb" do
  before(:each) do
    assign(:druginfograph, stub_model(Druginfograph,
      :brand_name => "MyString",
      :avg_sat_male => 1.5,
      :avg_sat_female => 1.5,
  ...
  it "renders new druginfograph form" do
    render

    # Run the generator again with the --webrat-matchers flag if you want to use webrat matchers
    assert_select "form", :action => druginfographs_path, :method => "post" do
