...
describe "conditioninfographs/new.html.erb" do
  before(:each) do
    assign(:conditioninfograph, stub_model(Conditioninfograph,
      :condition_id => 1,
  ...
  it "renders new conditioninfograph form" do
    render

    # Run the generator again with the --webrat-matchers flag if you want to use webrat matchers
    assert_select "form", :action => conditioninfographs_path, :method => "post" do
